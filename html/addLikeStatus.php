...
VALUES ($profileId, 1, $imageId, $notified, now(), 0)";
$notif = mysqli_query ($conn, $notifQuery);

$deleteOldNotifQuery = "DELETE FROM notifications WHERE notifierId=$profileId AND notifiedId=$notified AND notifType=11 AND imageId=$imageId";
